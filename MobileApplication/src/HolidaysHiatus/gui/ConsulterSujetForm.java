...
public class ConsulterSujetForm extends Form {
    ...
    public ConsulterSujetForm(Resources theme, Sujet s) {
        ...
        this.lien = s.getLien_image();
            getToolbar().addMaterialCommandToLeftBar("", FontImage.MATERIAL_ARROW_BACK, e -> new SujetsForm(theme,bid).show());
    ...
    private void addGUIs() {
        ...
        String url = "http://127.0.0.1:8000/im/" + lien;
