...
public class HomePageFrom extends Form{
    ...
    public HomePageFrom(Resources theme) {
        ...
        InscriptionViaFacebook.setUIID("fbinsc");
        ConnexionViaFacebook.setUIID("fbinsc");
        InscriptionViaFacebook.setMaterialIcon(FontImage.MATERIAL_FACEBOOK);
        ConnexionViaFacebook.setMaterialIcon(FontImage.MATERIAL_FACEBOOK);
