...
public class ProduitServiceFormController implements Initializable {
    ...
    private void valider(ActionEvent event) {
        ...
        }else if(actiontype.compareTo("Ajouter")==0){
            ProduitServiceCRUD servicep= new ProduitServiceCRUD();
        ...
        servicep.ajouterProduitService(new ProduitService(Integer.parseInt(catid.getText()),titre.getText(),description.getText(),type.getText(),Float.parseFloat(prixunitaire.getText()),Session.getSession().getConnectedBoard().getId()));
        }
    ...
    public static void SetItems (String actiontype) {
    ProduitServiceFormController.actiontype=actiontype;
