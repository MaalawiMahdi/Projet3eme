    ...
    // Write the output to a file
        try {
            ...
            workbook.write(fileOut);
                fileOut.close();
Desktop.getDesktop().open(new File("C:\\Users\\drwhoo\\Desktop\\Projet3eme\\JavaApplication\\Societe.xlt"));
    ...
    // Write the output to a file
        try {
            ...
            workbook.write(fileOut);
                fileOut.close();
        Desktop.getDesktop().open(new File("C:\\Users\\drwhoo\\Desktop\\Projet3eme\\JavaApplication\\Societe.xlt"));
JavamailUtil.sendMailWithFile(mail, "Liste des societe ", "Lise des societe", "C:\\Users\\drwhoo\\Desktop\\Projet3eme\\JavaApplication\\Societe.xlt");
        } catch (IOException ex) {
            Logger.getLogger(GenerateExcel.class.getName()).log(Level.SEVERE, null, ex);
        } catch (Exception ex) {
            Logger.getLogger(GenerateExcel.class.getName()).log(Level.SEVERE, null, ex);
